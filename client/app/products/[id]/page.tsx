...
export default function ProductDetailPage() {
  ...
  // ── Success screen for custom orders ──
  if (submitted) {
    return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Price — only show for regular products */}
            {!product.isCustom && (
            ...
            {product.isCustom && (
              <div className="bg-orange-50 border border-orange-200 px-4 py-3 text-sm text-orange-700">
                <strong>Price quoted after review.</strong> Submit your request below and we'll contact you with pricing within 24 hours.
              </div>
            )}
            ...
            {/* ── CUSTOM: Inquiry Form ── */}
            {product.isCustom ? (
              <form onSubmit={handleInquirySubmit} className="space-y-4 border-t border-gray-100 pt-4">
                ...
                {/* Address fields — only if home delivery */}
                {deliveryMethod === "HOME_DELIVERY" && (
